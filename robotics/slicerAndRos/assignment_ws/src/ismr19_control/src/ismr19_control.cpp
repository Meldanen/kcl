...
public:
  ...
  void result_cb( const moveit_msgs::ExecuteTrajectoryActionResult& result ){
    ...
    geometry_msgs::PoseStamped current_pose = move_group.getCurrentPose( "hand" );
  ...
  void igtl_point_cb ( const ros_igtl_bridge::igtlpoint& point ){
    if(point.name.compare("Entry") == 0){
      ...
      ROS_INFO("Entry point has been received: \n");
      ...
      ROS_INFO("Target point has been received: \n");
    }
  ...
  void execute(){
    ...
    seed.name.push_back( "panda_joint1" );
    seed.name.push_back( "panda_joint2" );
    seed.name.push_back( "panda_joint3" );
    seed.name.push_back( "panda_joint4" );
    seed.name.push_back( "panda_joint5" );
    seed.name.push_back( "panda_joint6" );
    seed.name.push_back( "panda_joint7" );
    seed.position.push_back( 0 );
    seed.position.push_back( -0.785 );
    seed.position.push_back( 0 );
    seed.position.push_back( -2.356 );
    seed.position.push_back( 0 );
    seed.position.push_back( 1.571 );
    seed.position.push_back( 0.785 );
