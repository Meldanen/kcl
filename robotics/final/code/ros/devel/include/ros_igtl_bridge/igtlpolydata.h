...
bool operator==(const ::ros_igtl_bridge::igtlpolydata_<ContainerAllocator1> & lhs, const ::ros_igtl_bridge::igtlpolydata_<ContainerAllocator2> & rhs)
{
  return lhs.name == rhs.name &&
    lhs.points == rhs.points &&
    lhs.polygons == rhs.polygons &&
    lhs.strips == rhs.strips &&
    lhs.lines == rhs.lines &&
    lhs.verts == rhs.verts;
}
