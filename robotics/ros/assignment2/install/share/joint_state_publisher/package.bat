...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\joint_state_publisher\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\joint_state_publisher\hook\ros_package_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\joint_state_publisher\hook\pkg_config_path.bat"
