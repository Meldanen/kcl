...
cd "C:/kcl/robotics/ros/catkin_ws/src/joint_state_publisher/joint_state_publisher"
...
"C:/opt/python27amd64/python.exe" ^
    ...
    build --build-base "C:/kcl/robotics/ros/catkin_ws/build/joint_state_publisher/joint_state_publisher" ^
    install %DESTDIR_ARG%  ^
